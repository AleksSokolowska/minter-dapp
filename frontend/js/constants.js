const contractAddress = "0xBc1BeCE7770847D8B037EaC47B4684A0724C0787"; // Replace with your own contract address
...
const h2_presale_coming_soon = "Free Whitelist Minting Countdown";
const h2_presale_mint = "Free Public Minting Countdown";
const p_presale_coming_soon = "We are working hard to launch the NFT Collection. Stay tuned for updates!";
const p_presale_mint_not_whitelisted = "Oh nooo, you are not whitelisted... 😢";
...
const p_public_mint = "No whitelist needed. Free public minting is now open! 🎉";
const button_presale_coming_soon = "Get on the Whitelist!";
const button_presale_mint_whitelisted = "Mint Your Free NFT";
const button_presale_mint_not_whitelisted = "Get on the Whitelist";
const button_presale_already_minted = "Join The Community";
const button_public_mint = "Mint Your Free NFT";
